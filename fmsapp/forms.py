...
from .models import Dam, Staff, Department, Fish, TimeLine, Sales, Debtors, Order
...
class LoginForm(AuthenticationForm):
    username = forms.CharField(max_length=10, widget=forms.TextInput(
        attrs={'class': 'form-control p-4 mb-3', 'placeholder': 'Username '}))
    password = forms.CharField(max_length=20, widget=forms.PasswordInput(
        attrs={'class': 'form-control p-4 mb-3', 'placeholder': 'Password '}))
...
class RegisterForm(UserCreationForm):
    first_name = forms.CharField(max_length=15, widget=forms.TextInput(
        attrs={'class': 'form-control p-4 mb-3', 'placeholder': 'First Name '}))
    last_name = forms.CharField(max_length=15, widget=forms.TextInput(
        attrs={'class': 'form-control p-4 mb-3', 'placeholder': 'Last Name '}))
    email = forms.CharField(max_length=50, widget=forms.TextInput(
        attrs={'class': 'form-control p-4 mb-3', 'placeholder': 'Mail '}))
    username = forms.CharField(max_length=10, widget=forms.TextInput(
        attrs={'class': 'form-control p-4 mb-3', 'placeholder': 'Username '}))
    ...
    password2 = forms.CharField(label='Confirm Password', max_length=20, widget=forms.PasswordInput(
        attrs={'class': 'form-control p-4 mb-3', 'placeholder': 'Confirm Password '}))
    ...
    class Meta:
        ...
        widgets = {
            ...
            'location': forms.Textarea(
                attrs={'class': 'form-control text-justify', 'placeholder': 'Dam Location', 'rows': 2}),
    ...
    class Meta:
        ...
        widgets = {
            ...
            'work_description': forms.Textarea(
                attrs={'class': 'form-control', 'placeholder': 'Work Description', 'rows': 2, 'cols': 4}),
            'image': forms.FileInput(attrs={'class': 'form-control'}),
        }
    ...
    class Meta:
        ...
        widgets = {
            'number': forms.NumberInput(
                attrs={'class': 'form-control', 'placeholder': 'Total Number of Fish Harvested'}),
    ...
    class Meta:
        ...
        widgets = {
            ...
            'amount': forms.NumberInput(
                attrs={'class': 'form-control', 'placeholder': 'Price per one per weight', 'id': 'amt'}),
            'weight': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Fish weight'}),
            'quantity': forms.NumberInput(
                attrs={'class': 'form-control', 'placeholder': 'Total Number of Fish', 'id': 'qty'}),
            'price': forms.NumberInput(
                attrs={'class': 'form-control', 'placeholder': 'Total Amount to be paid', 'id': 'prc',
                       'readonly': 'readonly'})
...
class OrderForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
             'name' : forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g Tilapia'}),
