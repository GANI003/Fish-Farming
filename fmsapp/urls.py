...
urlpatterns = [
    ...
    path('administrator/login1/', views.Login1.as_view(), name='login1'),
    path('administrator/register/', views.register, name='register'),
    path("dashboard/", views.Dashboard.as_view(), name="dashboard"),
   path("dashboard1/", views.Dashboard1.as_view(), name="dashboard1"),
   path("dashboard/logout/", views.Index.as_view(), name="logout"),
   ...
   path("dashboard1/dam1/", views.DamList1.as_view(), name="all_dam1"),
   ...
   path("dashboard/sales/all1/", views.SalesAll1.as_view(), name="sales1"),
   ...
   path("dashboard/sales/all1/order/",views.order,name="order"),
    #Credit Sales
